...
<ul class="socialnetworks">
	...
	<li><a href="<?php echo get_theme_mod('linkedin');  ?>" title="Linkedin" target="_blank"><i class="fab fa-linkedin-square"></i></a></li>
	<?php endif; ?>
	<?php if ( get_theme_mod('youtube') ) : ?>
	<li><a href="<?php echo get_theme_mod('youtube');  ?>" title="Youtube" target="_blank"><i class="youtube"><img src="<?php echo get_template_directory_uri(); ?>/assets/imgs/youtube.png" alt="Youtube"></i></a></li>
	<?php endif; ?>
</ul>
<?php endif; ?>